...
public class AtlasHiveHookContext {
    ...
    public AtlasHiveHookContext(HiveHook hook, HiveOperation hiveOperation, HookContext hiveContext,
        ...
        this(hook, hiveOperation, hiveContext, knownObjects, null);
    }

    public AtlasHiveHookContext(HiveHook hook, HiveOperation hiveOperation, HiveHookObjectNamesCache knownObjects,ListenerEvent listenerEvent) throws Exception {
        this(hook, hiveOperation, null, knownObjects, listenerEvent);
    }

    public AtlasHiveHookContext(HiveHook hook, HiveOperation hiveOperation, HookContext hiveContext, HiveHookObjectNamesCache knownObjects, ListenerEvent listenerEvent) throws Exception {
        this.hook             = hook;
        ...
        this.metastoreHandler =null;// (listenerEvent != null) ? metastoreEvent.getIHMSHandler() : null;
